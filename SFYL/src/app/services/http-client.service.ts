...
export class HttpClientService {
  ...
  /// Post Like
  public async LikeService(collectionName:string,docId:string,docIDs:string){
  ...
  public async UnLikeService(collectionName:string,docId:string,docIDs:string){
   ...
   public async UpdateData(collectionName:string,docId:string,gioitinh:string,noio:string,ngaysinh:string,sothich:[]){
